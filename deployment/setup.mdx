...
sidebarTitle: "Setup"
description: "Step-by-step deployment guide for Spades Online: self-hosting on a Linux server, deploying to Railway, or splitting frontend and WebSocket across Vercel and Railway."
---
