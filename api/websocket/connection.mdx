---
title: "Connect to the Spades Online WebSocket Server"
...
```json
{
  ...
  "payload": {
    "tableId": "<uuid>",
    "reason": "not_seated" | "table_not_found" | "error"
  }
}
```
...
| Reason | Meaning |
|---|---|
| `not_seated` | The authenticated player is neither seated at nor observing the table. |
