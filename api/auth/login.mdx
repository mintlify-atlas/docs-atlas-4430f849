---
title: "Log In and Out of Spades Online with Session Tokens"
sidebarTitle: "Login"
description: "Authenticate with email and password to receive a session token. All protected API endpoints require both x-session-id and x-player-id headers."
---
