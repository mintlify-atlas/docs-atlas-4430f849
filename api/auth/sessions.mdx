---
title: "Session Management and Authentication Headers"
sidebarTitle: "Sessions"
description: "How Spades Online sessions work: Redis-backed tokens, the x-session-id and x-player-id header protocol, and session lifecycle from login to logout."
---
...
- **Natural expiry** — sessions are stored in Redis with a **7-day TTL**. If the player does not log out manually, the session expires automatically after 7 days of inactivity.
