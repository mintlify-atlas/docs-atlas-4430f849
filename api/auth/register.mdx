---
title: "Register and Verify a Spades Online Account"
sidebarTitle: "Registration"
description: "POST /api/auth/register creates a new player account and sends a verification email. GET /api/auth/verify-email activates the account using the emailed token."
---
