---
title: "Create a New Table in Spades Online"
sidebarTitle: "Create Table"
description: "POST /api/tables creates a new game table. Configure visibility (public/friends-only/private), join policy, and spectating. Returns the tableId on success."
---
...
<Tabs>
  ...
  <Tab title="private">
    The table produces **no** lobby or friend-list notifications. It is completely unlisted. Only players who receive an explicit join link (`GET /api/tables/:tableId/join-link`) or an in-app invite (`POST /api/tables/:tableId/invite`) from the host can access it.
  </Tab>
</Tabs>
